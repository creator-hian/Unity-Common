...
namespace FileExtensions.FileType
{
    public class FileCategoryTest
    {
        ...
        {
            // Arrange & Act
            FileCategory textCategory = FileCategory.GetCategory("Text");
            FileCategory imageCategory = FileCategory.GetCategory("Image");
        ...
        {
            // Arrange & Act
            FileCategory category = FileCategory.GetCategory("NonExistentCategory");
        ...
        {
            // Arrange & Act
            FileCategory unknownCategory = FileCategory.Common.Unknown;
            FileCategory textCategory = FileCategory.Common.Text;
            FileCategory imageCategory = FileCategory.Common.Image;
        ...
        {
            // Arrange & Act
            FileCategory sceneCategory = FileCategory.Unity.Scene;
            FileCategory prefabCategory = FileCategory.Unity.Prefab;
            FileCategory scriptCategory = FileCategory.Unity.Script;
